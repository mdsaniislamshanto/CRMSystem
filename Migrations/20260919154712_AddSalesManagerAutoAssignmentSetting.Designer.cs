...
namespace CRMSystem.Migrations
{
    ...
    [Migration("20260919154712_AddSalesManagerAutoAssignmentSetting")]
    partial class AddSalesManagerAutoAssignmentSetting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRMSystem.Models.Entities.AutoAssignmentRequest", b =>
                {
                    ...
                    b.Property<bool>("RequestedStatus")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.ToTable("AutoAssignmentRequests");
                });
            ...
            modelBuilder.Entity("CRMSystem.Models.Entities.Feedback", b =>
                {
                    ...
                    b.Property<bool>("NextFeedbackSLAMissed")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("CRMSystem.Models.Entities.GoogleOAuthCredential", b =>
                {
                    b.Property<long>("CredentialId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<long>("CredentialId"));
            ...
            modelBuilder.Entity("CRMSystem.Models.Entities.LeadAssignment", b =>
                {
                    ...
                    b.Property<bool>("AcceptanceSLAMissed")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool>("FirstFeedbackSLAMissed")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("CRMSystem.Models.Entities.Notification", b =>
                {
            ...
            modelBuilder.Entity("CRMSystem.Models.Entities.ProfileChangeRequest", b =>
                {
                    b.Property<long>("RequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CRMSystem.Models.Entities.SystemSettings", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<long>("SettingId"));
            ...
            modelBuilder.Entity("CRMSystem.Models.Entities.AutoAssignmentRequest", b =>
                {
                    b.HasOne("CRMSystem.Models.Entities.User", "Requester")
                        .WithMany()
                        .HasForeignKey("RequestedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CRMSystem.Models.Entities.User", "Reviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("CRMSystem.Models.Entities.Lead", b =>
                {
                    b.HasOne("CRMSystem.Models.Entities.User", "ArchivedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CRMSystem.Models.Entities.Notification", b =>
                {
                    b.HasOne("CRMSystem.Models.Entities.LeadAssignment", "Assignment")
                        .WithMany()
                        .HasForeignKey("AssignmentId");
